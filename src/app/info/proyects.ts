...
export const proyects: ProyectSchema[] = [
  {
    ...
    image: '/images/proyects/e-comerce-tp-e-3-info.png',
  ...
  },
  {
    ...
    resumeES:
      'Wiki sencilla de Rick & Morty realizanda con React y TypeScript. Este fue el tercer proyecto propuesto en la especialización en React del informatorio. Esta Wiki permite buscar personajes, conocer informacion de los mundos de la serie y ver informacion de los capítulos. Todos los datos se obtienen desde la API de Rick&Morty y para realizar las consultas a la misma utilicé "React-Query" de TanStack. El manejo de rutas internas se hizo utilizando "React Router" de Remix Software, Inc.',
    resumeEN:
    ...
    image: '/images/proyects/rick&morty-wiki-tp-e-3-info.png',
  ...
  },
  {
    ...
    nameEN: 'Cart App',
    resumeES:
      'Carrito de compras hecho con React y TypeScript. Este proyecto fue propuesto durante las primeras semanas de la especialización en React del Informatorio. Permite agregar elementos al carrito y gestionarlos mostrando a la vez el total de la compra.',
    resumeEN:
    ...
    image: '/images/proyects/carrito-app-tp-e-3-info.png',
  ...
  },
  {
    ...
    resumeES:
      'Generador de consejos hecho con React. Este proyecto es uno de los propuestos en la página Frontend Mentor.',
    resumeEN:
      'Advice Generator made with React. This project is one of those proposed on the Frontend Mentor page.',
    image: '/images/proyects/advice-generator.png',
  ...
  },
  {
    ...
    resumeES:
      'Formulario interactivo de tarjetas de credito hecho con React. Este proyecto es uno de los propuestos en la página Frontend Mentor.',
    resumeEN:
      'Interactive credit card form made with React. This project is one of those proposed on the Frontend Mentor page.',
    image: '/images/proyects/interactive-card-details.png',
  ...
  },
  {
    ...
    nameEN: 'To do App',
    resumeES:
      'Es mi primer proyecto hecho con React. Es una simple aplicación para gestionar tareas y llevar un registro de las mismas.',
    resumeEN:
      "It's my first project made with React. It's a simple application to manage tasks and keep track of them.",
    image: '/images/proyects/to-do-app.png',
  ...
  },
  {
    ...
    nameEN: 'Calculator',
    resumeES:
      'Calculadora realizada solamente usando JS como proyecto introductorio en la etapa 3 del informatorio. El objetivo fue crear todos los elementos html desde JavaScript.',
    resumeEN:
    ...
    image: '/images/proyects/calculadora-tp-e-3-info.png',
  ...
  },
  {
    ...
    image: '/images/proyects/pokedex-tp-Launch-X.png',
  ...
  },
  {
    ...
    resumeES:
      'Calculadora realizada solamente usando JS como proyecto introductorio a Launch X.',
    resumeEN:
      'Calculator made only using JS as an introductory project to Launch X.',
    image: '/images/proyects/calculadora-tp-Launch-X.png',
