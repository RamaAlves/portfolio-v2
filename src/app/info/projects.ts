...
export const projects: ProjectSchema[] = [
  {
    ...
    resumeEN:
      "E-comerce made with React and TypeScript. This was the last project proposed during the Informatorio's React specialization. It is an e-commerce that has several types of users. You can obtain products from the Platzi Fake API, create new ones, update existing ones or delete them (as long as we are logged in with an admin user). We can freely browse the e-commerce and simulate purchases. For the latter we must create a user that allows us to have a cart and manipulate the objects in it. Cart data and some user data have local persistence. To make the queries to the API I used 'React-Query' from TanStack. Internal routes management were done using 'React Router' from Remix Software, Inc.",
  ...
  },
  {
    ...
    resumeES:
      'Wiki de Rick & Morty realizanda con React y TypeScript. Este fue el tercer projecto propuesto en la especialización en React del informatorio. Esta Wiki permite buscar personajes, conocer informacion de los mundos de la serie y ver informacion de los capítulos. Todos los datos se obtienen desde la API de Rick&Morty y para realizar las consultas a la misma utilicé "React-Query" de TanStack. El manejo de rutas internas se hizo utilizando "React Router" de Remix Software, Inc.',
    resumeEN:
      "Rick and Morty wiki made with React and TypeScript. This was the third project proposed in the Informatorio's React specialization. This Wiki allows you to search for characters, learn information about the worlds of the series and see information about the chapters. All the data is obtained from the Rick&Morty's API and to query it, I used 'React-Query' from TanStack. Internal routes management were done using 'React Router' from Remix Software, Inc.",
  ...
  },
  {
    ...
    resumeEN:
      "Shopping cart made with React and TypeScript. This project was proposed during the first weeks of the Informatorio's React specialization. Allows you to add items to the cart and manage them while showing the total purchase.",
  ...
  },
  {
    ...
    resumeEN:
      "This is my first project made with React. It's a simple application to manage tasks and keep track of them.",
  ...
  },
  {
    ...
    nameEN: 'Pokedex',
    resumeES:
      'Pokedex realizada con Vanilla JS. Con esta app aprendí y practiqué como consumir APIs. Este proyecto fue propuesto durante el cursado de "Launch X".',
    resumeEN:
      'Pokedex made with Vanilla JS. With this app I learned and practiced how to consume APIs. This project was an assignament during "Launch X".',
